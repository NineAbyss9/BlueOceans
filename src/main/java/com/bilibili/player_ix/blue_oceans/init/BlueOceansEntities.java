...
public class BlueOceansEntities {
    ...
    public static final RegistryObject<EntityType<Freak>> FREAK = register("freak", EntityType.Builder.<Freak>of(Freak::new, MobCategory.MONSTER).setCustomClientFactory(Freak::new), 0.6f, 1.95f);
    ...
    public static final RegistryObject<EntityType<RedPlumWorm>> RED_PLUM_WORM = register("red_plum_worm", EntityType.Builder.<RedPlumWorm>of(RedPlumWorm::new, MobCategory.MONSTER).setCustomClientFactory(RedPlumWorm::new),  0.4f, 0.3f);
