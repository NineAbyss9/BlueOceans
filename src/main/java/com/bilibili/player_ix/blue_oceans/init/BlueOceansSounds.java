...
public class BlueOceansSounds {
    ...
    public static final RegistryObject<SoundEvent> DUCK_IDLE = register("duck_idle");
    public static final RegistryObject<SoundEvent> HONK = register("honk");
    public static final RegistryObject<SoundEvent> RING = register("ring");
    ...
    public static final RegistryObject<SoundEvent> SNIPER_RIFLE_FIRE = register("sniper_rifle_fire");
    ...
    private static RegistryObject<SoundEvent> register(String name) {
        return SOUNDS.register(name, () -> SoundEvent.createVariableRangeEvent(BlueOceans.location(name)));
    }
}
