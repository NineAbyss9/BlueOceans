...
package com.bilibili.player_ix.blue_oceans.client.model.villager;
...
public class HuntingVillagerModel<T extends Mob & IBOMob>
extends HierarchicalModel<T>
implements ArmedModel, HeadedModel {
    public static final ModelLayerLocation LOCATION = new ModelLayerLocation(BlueOceans.location("hunting"),
            "main");
    ...
    public HuntingVillagerModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    /* public void setAllVisible(boolean p_102880_) {
        ...
        this.hat.visible = p_102880_; do you
        this.root.visible = p_102880_;
