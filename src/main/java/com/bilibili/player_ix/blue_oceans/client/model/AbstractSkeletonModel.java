...
extends HumanoidModel<T> {
        ...
        switch (pose) {
            case ATTACKING:{
                if (pEntity.getMainHandItem().isEmpty()) {
                    AnimationUtil.animateZombieArms(this.leftArm, this.rightArm, true, this.attackTime,
                            pAgeInTicks);
                } else {
    ...
    public void setupAnima(T p_103798_, float p_103799_, float p_103800_, float p_103801_, float p_103802_, float p_103803_) {
